...
const Edit = () => {
  ...
  const editSkills = (serviceIndex, editService) => {
    let copySkills = data.skills;
    copySkills[serviceIndex] = { ...editService };
  ...
  const deleteService = (id) => {
    ...
    copySkills = copySkills.filter((service) => service.id !== id);
    setData({ ...data, skills: copySkills });
  };
      ...
      <div className="mt-10">
        ...
        {currentTabs === "HEADER" && (
          <div className="mt-10">
            ...
            <div className="mt-5 flex items-center">
              <label className="w-1/5 text-lg opacity-50">Education</label>
              <div className="w-4/5 ml-10 flex items-center">
                <Button
                  onClick={() => setData({ ...data, showEducation: true })}
                  type={data.showEducation && "primary"}
                >
                  Yes
                </Button>
                <Button
                  onClick={() => setData({ ...data, showEducation: false })}
                  classes={
                    !data.showEducation && "bg-red-500 text-white hover:bg-red-600"
                  }
                >
                  No
                </Button>
